...
\newpage
\subsubsection{Farmers' Expectations on Buyers' Competitiveness on Binary Storage Decisions}
...
\newpage
\subsubsection{Hazard Models with AFT parametrization}
\paragraph{Key Concepts and Framework}
...
\paragraph{Hazard Model with AFT Parameterization}
