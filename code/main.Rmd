...
pie_chart <- ggplot(storage_counts, aes(x = "", y = count, fill = storage_type)) +
  ...
  geom_text_repel(aes(label = label),  nudge_x = 1, size = 5, show.legend = FALSE) +
...
ggsave(here("figures","storage_usage_analysis_soft_colors.png"), combined_plot, width = 12, height = 6, dpi = 300)
