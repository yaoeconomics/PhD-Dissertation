...
panel1_vars <- c("age", "hh_size", "labor_size", "education_highest", "family_ever_village_leader", "liquidity_constraint")
panel1_names <- c("Age (years)", "Household size (persons)", "Labor size (persons)", "Highest education (level)", "Family ever village leader (dummy)", "Liquidity constrained (dummy)")
...
# Save the plot
ggsave(here("figures","filtered_difference_from_baseline_plot.png"), diff_plot, width = 8, height = 5, dpi = 300)
