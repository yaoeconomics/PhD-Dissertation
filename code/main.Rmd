...
# Identify storage users and non-storage users
...
\\toprule\
")
latex_output <- paste0(latex_output, " & \\multicolumn{2}{c}{Storage Users} & \\multicolumn{2}{c}{Non-Storage Users} & Difference \\\\\
")
